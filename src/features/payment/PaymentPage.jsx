          ...
          {submit && Object.keys(formError).length === 0 ? (
            ...
            <section className="payment__inner">
              ...
              <form onSubmit={handleSubmit} className="payment__form">
                ...
                <span id="firstname-error" aria-live="polite" className="payment__form__error">
                  {formError.firstname}
                </span>
                ...
                />
                <span id="lastname-error" aria-live="polite" className="payment__form__error">
                  {formError.lastname}
                </span>
                ...
                />
                <span id="cardNumber-error" aria-live="polite" className="payment__form__error">
                ...
                <div className="payment__form__cvv-exp">
                  <div className="payment__form__section">
                    ...
                    />
                    <span id="cvv-error" aria-live="polite" className="payment__form__error">
                      {formError.cvv}
                    </span>
                  </div>
                  <div className="payment__form__section">
                    <label id="expiration-label">Expiration Date (MM/YY)</label>
                    <div className="payment__form__expiration" aria-labelledby="expiration-label">
                      <input
                        autoComplete="off"
                        id="month"
                        name="month"
                    ...
                    <span id="year-error" aria-live="polite" className="payment__form__error">
                      {formError.year}
                    </span>
                  </div>
                </div>
