...
const FooterContact = () => {
  return (
    <section className="footer__contact flex-container flex-column">
      ...
      <address>
        <p><a href="tel:0000001234567" aria-label="Call us at 0000001234567">000 (000) 123 4567</a></p>
        <p><a href='mailto:pizza@pizzatime.com' aria-label="Email us at pizza at pizzatime dot com">pizza@pizzatime.com</a></p>
      ...
      <section className="footer__contact__payments">
        ...
        <ul className="footer__contact__payments-img">
          <li><img width="50" height="50" src={Visa} alt="Visa credit or debit card accepted" /></li>
          <li><img width="50" height="50" src={MasterCard} alt="Mastercard credit or debit card accepted" /></li>
          <li><img width="50" height="50" src={ApplePay} alt="Apple Pay payment accepted" /></li>
          <li><img
            width="50"
            height="50"
            className="googlepay"
