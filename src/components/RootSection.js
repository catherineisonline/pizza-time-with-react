  ...
  return (
    <article className="section-3 flex-container flex-column txt-center">
      ...
      <p className="pop-font section-introduction">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
        consequat nibh qua. Pellentesque ac leo at elit consequat aliquet. Lorem
        ipsum dolor sit amet, consectetur adipiscing elit. Vivamus consequat
        nibh qua.
      </p>
...
const SectionFive = () => {
  return (
    <article className="section-5 flex-container ">
      ...
      <p className="section-description">
        Vestibulum et viverra massa, a malesuada lacus. Curabitur quis elit eget
        metus porttitor sollicitudin at in nulla. Integer mollis orci vel
        consequat eleifend. Fusce sollicitudin feugiat magna et facilisis.
      </p>
      <section className="pricing-grid flex-container flex-column">
        {/* Pizza 1 */}
        <Link to="/pizza" className="pricing-grid-item flex-container flex-row">
      ...
      <section className="blog-posts-landing">
        ...
        <div className="blog-post flex-container flex-column">
          ...
          <p className="blog-snippet">
            Maecenas interdum erat justo, eget posuere mi vehicula et. Fusce ut
            elit ex.
          </p>
        </div>
        {/* Post 2 */}
    ...
    <article className="section-11  flex-container flex-column">
      <section className="email-subscribtion">
        ...
        <section className="input-section">
          ...
          ></input>
          <button onClick={SubmitEmail} className="landing-email-btn">
            Sign me up
          </button>
