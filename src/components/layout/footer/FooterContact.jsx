    ...
    <section className="footer__contact flex-container flex-column">
      ...
      <section className="footer__contact__payments">
        ...
        <ul className="footer__contact__payments-img">
          <li>
            <img width="50" height="50" src={Visa} alt="Visa credit or debit card accepted" />
          </li>
          <li>
            <img width="50" height="50" src={MasterCard} alt="Mastercard credit or debit card accepted" />
          </li>
          <li>
            <img width="50" height="50" src={ApplePay} alt="Apple Pay payment accepted" />
          </li>
          <li>
            <img width="50" height="50" className="googlepay" src={GooglePay} alt="Google Pay payment accepted" />
          </li>
        </ul>
      </section>
    </section>
